...
{
    [Area("Admin")]
    public class _AdminAccountsController : Controller
    {
        private readonly MinimartDBContext _context;

        public _AdminAccountsController(MinimartDBContext context)
        {
            _context = context;
        }
        ...
        // GET: Admin/_AdminAccounts/Details/5
        ...
        // GET: Admin/_AdminAccounts/Create
        ...
        // POST: Admin/_AdminAccounts/Create
        ...
        // GET: Admin/_AdminAccounts/Edit/5
        ...
        // POST: Admin/_AdminAccounts/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/_AdminAccounts/Delete/5
        ...
        // POST: Admin/_AdminAccounts/Delete/5
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MinimartDBContext.Accounts'  is null.");
            }
            var account = await _context.Accounts.FindAsync(id);
            if (account != null)
            {
